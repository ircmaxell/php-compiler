...
class Value extends Type
{
    ...
    {
        $fn___a87ff679a2f3e71d9181a67b7542122c = $this->context->lookupFunction(
            '__value__toNumeric'
        );
        $block___a87ff679a2f3e71d9181a67b7542122c = $fn___a87ff679a2f3e71d9181a67b7542122c->appendBasicBlock(
            'main'
        );
        $this->context->builder->positionAtEnd(
            $block___a87ff679a2f3e71d9181a67b7542122c
        );
    ...
    {
        $fn___d3d9446802a44259755d38e6d163e820 = $this->context->lookupFunction(
            '__value__readLong'
        );
        ...
        $this->context->builder->positionAtEnd(
            $block___d3d9446802a44259755d38e6d163e820
        );
    ...
    {
        $fn___9bf31c7ff062936a96d3c8bd1f8f2ff3 = $this->context->lookupFunction(
            '__value__writeLong'
        );
        $block___9bf31c7ff062936a96d3c8bd1f8f2ff3 = $fn___9bf31c7ff062936a96d3c8bd1f8f2ff3->appendBasicBlock(
            'main'
        );
        $this->context->builder->positionAtEnd(
            $block___9bf31c7ff062936a96d3c8bd1f8f2ff3
        );
    ...
    {
        $fn___70efdf2ec9b086079795c442636b55fb = $this->context->lookupFunction(
            '__value__readDouble'
        );
        $block___70efdf2ec9b086079795c442636b55fb = $fn___70efdf2ec9b086079795c442636b55fb->appendBasicBlock(
            'main'
        );
        $this->context->builder->positionAtEnd(
            $block___70efdf2ec9b086079795c442636b55fb
        );
    ...
    {
        $fn___b6d767d2f8ed5d21a44b0e5886680cb9 = $this->context->lookupFunction(
            '__value__writeDouble'
        );
        $block___b6d767d2f8ed5d21a44b0e5886680cb9 = $fn___b6d767d2f8ed5d21a44b0e5886680cb9->appendBasicBlock(
            'main'
        );
        $this->context->builder->positionAtEnd(
            $block___b6d767d2f8ed5d21a44b0e5886680cb9
        );
    ...
    {
        $fn___1ff1de774005f8da13f42943881c655f = $this->context->lookupFunction(
            '__value__readString'
        );
        $block___1ff1de774005f8da13f42943881c655f = $fn___1ff1de774005f8da13f42943881c655f->appendBasicBlock(
            'main'
        );
        $this->context->builder->positionAtEnd(
            $block___1ff1de774005f8da13f42943881c655f
        );
    ...
    {
        $fn___33e75ff09dd601bbe69f351039152189 = $this->context->lookupFunction(
            '__value__writeString'
        );
        $block___33e75ff09dd601bbe69f351039152189 = $fn___33e75ff09dd601bbe69f351039152189->appendBasicBlock(
            'main'
        );
        $this->context->builder->positionAtEnd(
            $block___33e75ff09dd601bbe69f351039152189
        );
