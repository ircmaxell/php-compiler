...
// Make your changes in /compiler/script/../lib/JIT/Builtin/MemoryManager/Native.pre instead.
...
class Native extends MemoryManager
{
    public function register(): void
    {
        ...
        $fntype___cfcd208495d565ef66e7dff9f98764da = $this->context->context->functionType(
                $this->context->getTypeFromString('int8*'),
                false,
                $this->context->getTypeFromString('int8*'), $this->context->getTypeFromString('size_t')
