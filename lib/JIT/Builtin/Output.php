...
// Make your changes in /compiler/script/../lib/JIT/Builtin/Output.pre instead.
...
class Output extends Builtin
{
    public function register(): void
    {
        ...
        $fntype___cfcd208495d565ef66e7dff9f98764da = $this->context->context->functionType(
                $this->context->getTypeFromString('int32'),
                true,
                $this->context->getTypeFromString('char*'), $this->context->getTypeFromString('char*')
        ...
        $fntype___cfcd208495d565ef66e7dff9f98764da = $this->context->context->functionType(
                $this->context->getTypeFromString('int32'),
                true,
                $this->context->getTypeFromString('char*'), $this->context->getTypeFromString('size_t'), $this->context->getTypeFromString('char*')
