...
// Change /compiler/lib/Builtin/MemoryManager/PHP.pre instead.
...
class PHP extends MemoryManager
{
    public function register(): void
    {
        ...
        if (\PHP_DEBUG) {
            ...
            $fn___c4ca4238a0b923820dcc509a6f75849b = $this->context->module->addFunction(
                '_emalloc',
                $fntype___c4ca4238a0b923820dcc509a6f75849b
            );
    ...
    public function implement(): void
    {
        if (\PHP_DEBUG) {
            ...
            $this->context->builder->call($this->context->lookupFunction('_efree'), $void, $jit, $two, $jit, $two);
            $this->context->builder->returnVoid();

            $this->context->builder->clearInsertionPosition();
        } else {
            $fn___45c48cce2e2d7fbdea1afc51c7c6ad26 = $this->context->lookupFunction('__mm__malloc');
            $block___45c48cce2e2d7fbdea1afc51c7c6ad26 = $fn___45c48cce2e2d7fbdea1afc51c7c6ad26->appendBasicBlock(
                'main'
            );
            ...
            $result = $this->context->builder->call($this->context->lookupFunction('_emalloc'), $size);
            $this->context->builder->returnValue($result);
            ...
            $result = $this->context->builder->call($this->context->lookupFunction('_erealloc'), $void, $size);
            $this->context->builder->returnValue($result);

            $this->context->builder->clearInsertionPosition();
            $fn___c51ce410c124a10e0db5e4b97fc2af39 = $this->context->lookupFunction('__mm__free');
            $block___c51ce410c124a10e0db5e4b97fc2af39 = $fn___c51ce410c124a10e0db5e4b97fc2af39->appendBasicBlock(
                'main'
            );
            ...
            $this->context->builder->call($this->context->lookupFunction('_efree'), $void);
            $this->context->builder->returnVoid();
